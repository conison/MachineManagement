...
function Detail({ machine }) {
  ...
  useEffect(() => {
    // Fetch services and processes when the machine changes
    const loadServicesAndProcesses = async () => {
      try {
        const servicesData = await fetchServices(machine.name); // Assuming machine.name is the ID or identifier
    ...
    <div className="detail">
      ...
      <div className="sidebar">
        <ul>
          ...
          <li onClick={() => setActiveTab("processes")}>Processes</li>
